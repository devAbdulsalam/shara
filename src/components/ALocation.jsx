  ...
  return (
    <div>
      ...
      <Iframe
        ...
        position="relative"
      />
      <div class="flex justify-between items-center p-3 bg-transparent fixed z-[44]">
        <div class="absolute left-10 top-28">
          <div
            class="shadow-xl cursor-pointer rounded-full p-10 bg-primary absolute -z-10 blur-xl"
            alt=""
          >
            {" "}
          </div>
          <div
            class="shadow-xl cursor-pointer animate-ping duration-500 rounded-full p-10 bg-primary absolute -z-10"
            alt=""
          >
            {" "}
          </div>
          {/* <img src="./assets/Group 3.png" class="cursor-pointer p-3" onclick="openMenu()" alt=""> */}
        </div>
          ...
          <div className="lg:max-w-2xl mx-auto my-5 p-5 flex flex-col justify-center shadow-md bg-white text-gray-800  rounded-xl">
            ...
            <div className="pt-5 w-full mx-auto flex justify-around">
              ...
              <button
                ...
                className="bg-blue-700 text-white font-bold py-2 px-8 hover:bg-blue-500 rounded-md"
              >
                Submit
              </button>
            </div>
