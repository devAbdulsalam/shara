...
const calculateTotal = () => {
    ...
    return (
    <div>
        <div className="flex text-[#407BFF] justify-between rounded-b-[1rem] p-4">
        <a href="login.html">
            <div className="flex ">
                ...
                <div className="py-3">
                    <div className="">
                        ...
                        <div className='text-red-500'>
                            ...
                            <div className='flex gap-2 my-2 items-center'>
                                <input type="number" id="" 
                                    className="px-3 py-1.5 text-lg font-normal text-red-500 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"                                
